...
async def ingest_ses_event(session: AsyncSession, event: dict) -> dict:
    ...
    # An open/click is exactly the kind of signal event the score-based
    # Target/Contacted -> Engaged rule should react to immediately rather than
    # on any periodic schedule.
