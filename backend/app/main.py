...
from app.routers import auth, organisations, players, games, webhooks, leaderboard, records, admin, achievements, clubs, club_admin, statlab, yearbooks, award_definitions, images, og_preview, notifications, seo, families, manual_entries, usage, fees, fixtures, teams, availability, selection, ladders, iq, public_availability, net_manager, website
...
async def lifespan(app: FastAPI):
    ...
    async with engine.begin() as conn:
        ...
        """))
        # ─── Front-end Website (migration 069) ───────────────────────────────
