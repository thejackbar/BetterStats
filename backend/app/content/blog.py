...
BLOG_POSTS: list[dict] = [
    {
        ...
        "body": [
            ...
            {"type": "p", "text": "The obvious fix is to read the competition off the fixture data and group by it. We checked before building anything, and it is not there. A fixture tells us about the season, the grade, the match and the scorecard, and at no point names the competition a grade sits under. It is written down elsewhere, but nowhere we could read reliably enough to hang a button on."},
            {"type": "p", "text": "What a fixture does tell us, on every single grade, is the association that runs it. That turned out to be enough to work with, and it goes back as far as a club's records do. We checked against a club whose records run back to the mid-1970s, and the association was there on its oldest season."},
