...
BLOG_POSTS: list[dict] = [
    {
        ...
        "body": [
            ...
            {"type": "p", "text": "Then there is a breakdown, because a filter tells you how you went in one competition and not how they compare. A club page lists your record in each competition side by side with the grades under each, and every player profile has a Competitions tab that puts their batting, bowling and fielding in each one next to each other."},
            ...
            {"type": "p", "text": "New matches pick up the association on every sync, so this looks after itself going forward. Older seasons need one pass from us to fill it in, and that is a message to support rather than a job for anyone at the club."},
