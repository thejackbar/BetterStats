...
window.SAMPLE_TEAM = {
  name: "NORTHGATE",
  fullName: "Northgate Cricket Club",
  city: "NORTHGATE",
  short: "NGC",
...
window.SAMPLE_RESULT = {
  ...
  oppScore: "154/9 (20)",
  motmLast: "HOLT",
  // Top 3 performers per side, shown on the final-score template.
  topBatters: {
    team:     [{ last: "HOLT",     line: "87 (54)" }, { last: "RAO",      line: "42 (31)" }, { last: "COLE",     line: "28 (19)" }],
    opponent: [{ last: "BAILEY",   line: "55 (38)" }, { last: "HUSSAIN",  line: "36 (29)" }, { last: "THORNTON", line: "19 (15)" }],
  },
  topBowlers: {
    team:     [{ last: "WHITFIELD", line: "3-22 (4)" }, { last: "MARO",      line: "2-28 (4)" }, { last: "STRATTON", line: "2-31 (4)" }],
    opponent: [{ last: "DAWES",     line: "2-34 (4)" }, { last: "OKAFOR",    line: "1-26 (4)" }, { last: "MUKHERJEE", line: "1-30 (4)" }],
  },
};

// Used by the Milestone template (T7) — celebrating a player's achievement.
window.SAMPLE_MILESTONE = {
  player: { first: "Marcus", last: "HOLT", role: "BAT", roleLong: "Top-Order Batter", headshot: "assets/player-cutout.png" },
  value:  "200",                          // big number
  unit:   "GAMES",                        // label after the number
  reason: "200TH GAME FOR THE CLUB",      // longer eyebrow text
  detail: "15 seasons · 4,872 runs · 38 fifties · 6 centuries",
};

// Generic announcement used by C1. Pick any kind and supply your own text.
window.SAMPLE_ANNOUNCEMENT = {
  kind:        "APPOINTMENT",            // freeform short label (eyebrow chip)
  headline:    "NAMED CAPTAIN",          // big top line (small)
  subheadline: "FOR THE 2025\u201326 SEASON", // small caps below the name
  player:      { first: "Marcus", last: "HOLT", role: "BAT", roleLong: "Top-Order Batter", headshot: "assets/player-cutout.png" },
};
