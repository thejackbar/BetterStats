...
// Who is eligible to vote on this fixture but hasn't. Backend supplies
// fixture.outstanding = [{ id, name, photo_url, channel }] where channel is
// 'sms' | 'whatsapp' | 'none' (derived from the player's contact record).
          ...
          <div className="flex flex-col">
            {list.map((p) => (
              <div key={p.id} className="flex items-center gap-2.5 py-2.5 border-t pb-hairline">
                ...
                <span className="font-mono text-[10px] text-pb-faintest uppercase">{p.channel}</span>
              </div>
            ))}
          </div>
