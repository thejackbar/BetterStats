...
CREATE TABLE IF NOT EXISTS player_season_stats (
    ...
    five_wicket_innings INT DEFAULT 0,
    wides INT DEFAULT 0,
    no_balls INT DEFAULT 0,
    -- Fielding
    catches INT DEFAULT 0,
    catches_wk INT DEFAULT 0,
    catches_non_wk INT DEFAULT 0,
    run_outs INT DEFAULT 0,
    assisted_run_outs INT DEFAULT 0,
    unassisted_run_outs INT DEFAULT 0,
    stumpings INT DEFAULT 0,
    CONSTRAINT uq_player_season UNIQUE (player_id, season_id)
);

-- Career batting totals (aggregated from season stats)
