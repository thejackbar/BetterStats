export default {
  ...
  "items": [
    "New Super Admin tool to bring a club's KlubPro data into BetterStats: a review wizard that matches players by name and fills in profile details (gender, contact, role, batting/bowling, skills, photo) — it only fills gaps and never overwrites existing values or any stats",
