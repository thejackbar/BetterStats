export default {
  ...
  items: [
    ...
    'No double-counting, ever: where your sheet and the online data overlap, the online data wins, and only the part it’s missing is added on top. A player who appears in both can’t be inflated.',
