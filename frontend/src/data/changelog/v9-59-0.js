export default {
  ...
  items: [
    'A strike rate needs runs and balls faced from the same innings. Plenty of cricket is still scored in a written book, and older records rarely recorded balls faced at all, so a season could hold every run a batter made and a ball count for only some of those innings. Dividing all the runs by only some of the balls gives a figure far too high — 500 runs against a recorded 150 balls would read as a strike rate of 333.',
