export default {
  ...
  items: [
    ...
    'Team/grade filter no longer shows a duplicate “1st Grade” for every season, only offers grades the club actually fielded in the selected season (no more empty dashboards), and changing the grade now actually filters the data.',
    ...
    'Selection — analyse and build a team even when nothing is saved: the page loads a suggested best-available XI from your full eligible squad, lists every squad player’s availability, and lets you add or remove players from the XI right here before sending it back to BetterSelect. The availability list can be filtered by squad and flags anyone already picked in another upcoming fixture, and suggestions now respect BetterSelect eligibility — no women, lower-grade or years-dormant players suggested for the wrong side, however good their form.',
  ],
}
