export default {
  ...
  items: [
    ...
    'New UTM matching panel: lists every value a visit can be matched by (a utm_source or utm_id tag, or the club page someone landed on) and lets you map the odd ones to a club by hand (a campaign source like "executive", or a generic "willetton-cricket-club" slug that fits several clubs), or mark noise like "meta" as ignored. Mapped values then count towards that club\'s visits everywhere.',
  ],
}
