export default {
  ...
  items: [
    ...
    'Figures already stored are corrected by a one-off run over each club, so a club does not need to re-sync its history. Season totals that BetterCricket had worked out itself, for the seasons Cricket Australia leaves a player out of, are recalculated in the same pass.',
  ],
}
