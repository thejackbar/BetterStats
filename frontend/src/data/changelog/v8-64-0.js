export default {
  ...
  items: [
    ...
    'The Dashboard\'s "Subscribe" button (was "Request to subscribe") now takes you straight to Account > Plan & Billing, where you tick the modules you want and hit Subscribe to send the request through.',
