export default {
  ...
  items: [
    ...
    'After a bulk award import, the step that links names to players now searches your whole player list, not only the close matches it found. You can link a name to any player, and names it did not recognise can be linked right there as well instead of being left for later.',
