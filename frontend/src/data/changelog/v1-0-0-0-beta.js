export default {
  ...
  "items": [
    ...
    "Manual games now show up in fixture lists alongside synced games — both for clubs with synced data and clubs without it. Clicking through opens the same scorecard view (it transparently falls back to the manual_games table when the ID isn't in the synced games table).",
