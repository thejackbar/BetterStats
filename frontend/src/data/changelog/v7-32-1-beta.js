export default {
  ...
  "items": [
    ...
    "Cricket Australia gives the same person the same ID at every club they play for, and a second club's sync was attaching its seasons to the player's card. Each club's profile now only ever counts the seasons that belong to that club.",
