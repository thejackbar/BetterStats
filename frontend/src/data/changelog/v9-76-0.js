export default {
  version: 'v9.76.0',
  date: '2026-09-10',
  // Above v9.75.0's sortKey, or SITE_VERSION never reaches this one. Check
  // origin/main at merge time.
  sortKey: '2026-09-23T06:00:00Z',
  ...
  items: [
    ...
    'Two of the event posters, Gazette and Swiss, are drawn as one framed piece rather than separate parts, so they come up as a single layer. A scorecard split into two Instagram squares lists your own blocks and not the layout.',
