export default {
  ...
  items: [
    ...
    'That refusal now says the clashing role exists as a committee role managed on the Committee screen, so you know where it is instead of hunting for a role that is not on the list. Give the new one a different name. Renaming a role onto the same hidden committee role reads the same way.',
  ],
}
