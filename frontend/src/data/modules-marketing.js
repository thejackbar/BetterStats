...
export const MODULES_MARKETING = [
  ...
  },
  {
    ...
    summary:
      'Design clean, club-branded social graphics straight from your live data — lineups, fixtures, results and milestones — without opening a design tool.',
    highlights: [
      'Club-branded post designer',
      'Lineups, fixtures, results & milestones',
      'Your crest, colours & sponsors baked in',
      'Export and share in a tap',
    ],
    features: [
      { title: 'Post designer', desc: 'Compose share-ready graphics from data that’s already in your club site — no copy-paste, no design skills needed.' },
      { title: 'Built-in templates', desc: 'Team lineups, upcoming fixtures, match results and player milestones.' },
      { title: 'On-brand by default', desc: 'Every post carries your crest, club colours and sponsor logos.' },
