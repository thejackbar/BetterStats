...
export const MODULES_MARKETING = [
  ...
  },
  {
    ...
    screenshot: '/marketing/modules/bettersocials-lineup-card.jpg',
    gallery: [
      ...
      { src: '/marketing/modules/bettersocials-scorecard-broadcast.jpg', caption: 'Broadcast scorecard, auto-filled from your match data' },
      { src: '/marketing/modules/bettersocials-scorecard-app.jpg', caption: 'Scorecard, app-style dashboard layout' },
      { src: '/marketing/modules/bettersocials-lineup-hero.jpg', caption: 'Team lineup, hero layout' },
      { src: '/marketing/modules/bettersocials-website-home.jpg', caption: 'Your public, club-branded website' },
  ...
  },
  {
    ...
    gallery: [
      { src: '/marketing/modules/betteradmin-fees-schedule.jpg', caption: 'Fee schedules & membership tiers' },
      { src: '/marketing/modules/betteradmin-fees-payments.jpg', caption: 'Auto-allocating match-fee payments' },
      { src: '/marketing/modules/betteradmin-fees-reports.jpg', caption: 'Financial reports with waived totals' },
      { src: '/marketing/modules/betteradmin-comms.jpg', caption: 'Bulk email to your members (BetterComms)' },
    ],
  },
  {
    slug: 'betteriq',
