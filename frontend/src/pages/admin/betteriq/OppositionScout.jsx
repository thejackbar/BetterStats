...
export default function OppositionScout() {
  ...
  return (
    ...
    >
      ...
      {/* Player match-ups: our bowlers' hold over their batters (selection intel) */}
      {report?.matchups?.bowler_dominance?.length > 0 && (
        <div className="mb-4"><BowlerMatchups matchups={report.matchups} /></div>
      )}
