...
export default function Leaderboard() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    Promise.allSettled([
      api.battingLeaderboard(orgId, { seasonId: selectedSeason, gradeName: selectedGradeName, sortBy: battingSort, limit: 30, minRuns: effectiveMinRuns, minRateInnings: effectiveMinRateInnings, finalsOnly, captainOnly, gender, overseas, categories: categoriesParam, formats: formatsParam }),
      api.bowlingLeaderboard(orgId, { seasonId: selectedSeason, gradeName: selectedGradeName, sortBy: bowlingSort, limit: 30, minOvers: effectiveMinOvers, minWickets: effectiveMinWickets, minRateSpells: effectiveMinRateSpells, finalsOnly, captainOnly, gender, overseas, categories: categoriesParam, formats: formatsParam }),
  ...
  }, [orgId, selectedSeason, selectedGradeName, battingSort, bowlingSort, fieldingSort, effectiveMinRuns, effectiveMinOvers, effectiveMinWickets, effectiveMinRateInnings, effectiveMinRateSpells, finalsOnly, captainOnly, gender, overseas, categoriesParam, formatsParam])
