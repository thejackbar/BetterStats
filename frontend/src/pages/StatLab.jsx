...
const METRIC_LABELS = {
  ...
  catches_wk: { label: 'WK Catches', short: 'Ct (wk)', decimal: false },
  catches_non_wk: { label: 'Catches (outfield)', short: 'Ct (of)', decimal: false },
...
const PRESET_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'derived', key: 'dismissal_caught_behind',       label: 'Highest caught-behind count', description: 'Players most often caught behind by the wicketkeeper.' },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'preset', label: 'Most outfield catches (career)', target: 'player_career', sortBy: 'catches_non_wk', sortDir: 'desc', filters: [], context: {} },
      { type: 'preset', label: 'Wicket-keeper catches',     target: 'player_career', sortBy: 'catches_wk', sortDir: 'desc', filters: [], context: {} },
...
const DISMISSAL_OPTIONS = [
  ...
  { value: 'caught behind', label: 'Caught behind (wk)' },
  { value: 'lbw', label: 'LBW' },
...
const COLUMN_SETS = {
  player_career:    ['matches','batting_innings','runs','not_outs','batting_average','high_score','hundreds','fifties','ducks','wickets','bowling_average','bowling_economy','five_wicket_innings','catches','catches_wk','catches_non_wk','run_outs','stumpings'],
  player_season:    ['matches','batting_innings','runs','batting_average','high_score','hundreds','fifties','wickets','bowling_average','catches','catches_wk','catches_non_wk'],
  player_grade:     ['matches','batting_innings','runs','batting_average','high_score','hundreds','wickets','bowling_average','catches','catches_wk','catches_non_wk'],
  family_career:    ['member_count','matches','batting_innings','runs','batting_average','high_score','hundreds','fifties','ducks','wickets','bowling_average','five_wicket_innings','catches','catches_wk','catches_non_wk','run_outs','stumpings'],
  family_season:    ['member_count','matches','batting_innings','runs','batting_average','high_score','hundreds','wickets','bowling_average','catches','catches_wk','catches_non_wk'],
  family_grade:     ['member_count','matches','batting_innings','runs','batting_average','high_score','wickets','bowling_average','catches','catches_wk','catches_non_wk'],
...
const FILTER_CATEGORIES = [
  ...
  { key: 'fielding', label: 'Fielding',
    fields: ['catches','catches_wk','catches_non_wk','run_outs','stumpings'] },
