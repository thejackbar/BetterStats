  ...
  return (
    <div className={clsx(
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          {isWinner && <span className="text-xs text-accent font-semibold tracking-widest block mb-0.5">WINNER</span>}
          <p className="text-white font-medium text-sm leading-tight">{competitor.name}</p>
...
export default function MatchOverview() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {hasScores && (
        <div className="mb-5">
          <h3 className="display-heading text-base text-white mb-3">SCORES</h3>
          {hasCompetitors ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="card p-4">
                ...
                <p className="stat-number text-4xl font-bold text-accent leading-none">{game.home_score ?? '—'}</p>
              </div>
              <div className="card p-4">
                ...
                <p className="stat-number text-4xl font-bold text-white leading-none">{game.away_score ?? '—'}</p>
              </div>
            </div>
          )}
        </div>
      ...
      {/* PlayHQ scorecard link */}
      {game.url && (
        <div className="card p-4 mb-5 flex items-center justify-between gap-4">
          <div className="min-w-0">
            <p className="text-sm text-white font-medium">Full scorecard</p>
            <p className="text-xs text-slate-500 mt-0.5">Batting &amp; bowling figures on PlayHQ</p>
          </div>
          <a
            href={game.url}
            target="_blank"
