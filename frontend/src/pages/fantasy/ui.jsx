  ...
  if (logoUrl) {
    return (
      <img src={logoUrl} alt="" style={{
        width: size, height: size, borderRadius: radius, flex: 'none', objectFit: 'contain',
        background: '#fff', padding: Math.max(3, Math.round(size * 0.12)),
        boxShadow: 'inset 0 0 0 1px var(--hairline2)',
      }} />
    )
  }
  return (
