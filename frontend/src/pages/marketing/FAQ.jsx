    ...
    items: [
      {
        ...
        a: "Better Cricket is modular. BetterStats is $400 a year and includes your public stats site. From there you add only the modules you want: BetterSelect, BetterSocials, BetterAdmin and BetterFantasy are $100 a year each, and BetterIQ is $200. Take any two modules for 5% off, or the full set for 10%, which brings BetterStats plus every module to $900 a year. Every price covers unlimited players, seasons and teams, whatever the club's size.",
      },
      {
        q: 'What does each module include?',
        a: "BetterStats brings in every batting, bowling and fielding stat and turns it into your public club site, with player profiles, leaderboards, all-time records, partnerships, awards, season yearbooks and shareable stat cards. BetterSelect adds player availability, team selection and the net manager. BetterSocials adds social-post generation and a CRM with template pages and your club stats to run your public website. BetterAdmin adds member fee management, bulk emailing, and merch and stock management (coming soon). BetterIQ adds deep analytics and opposition scouting. BetterFantasy adds a season-long club fantasy league, scored automatically from your real match data.",
      },
      {
      ...
      },
      {
        ...
        a: "Up to two hours of dedicated support is included in your first year on BetterStats. If all of your club's match history is already uploaded, you should be up and running in no time. We'll guide you through merging players and grades if needed, and show you how to load all of your club's history into Better Cricket.",
      },
      {
