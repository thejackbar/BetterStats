    ...
    <section className="relative pt-32 pb-10 px-4 sm:px-6 lg:px-10 overflow-hidden">
      ...
      <div className="max-w-[1000px] mx-auto relative text-center">
        ...
        <p className="text-lg lg:text-xl text-pb-dim max-w-2xl mx-auto leading-relaxed">
          Every club starts with BetterStats. Add only the modules you want and bundle to save, up to
          $146 off the full set. One annual price, no per-player or per-team charges.
        </p>
      </div>
    </section>
  )
        ...
        <Reveal>
          <div className="text-center mb-8">
            ...
            <p className="text-pb-dim max-w-xl mx-auto">
              Annual prices, AUD. Bundle two or more modules and the discount kicks in, up to $146 off when you take all four (the full set comes to ${ALL_IN}).
            </p>
          </div>
        </Reveal>
        <Reveal>
...
function PricingFAQ() {
  ...
  const faqs = [
    ...
    { q: 'Are there any setup or migration fees?', a: "No. There is no migration fee, and onboarding support is included in your first year on BetterStats. If all of your club's match history is already uploaded, you should be up and running in no time, and we'll guide you through merging players and grades if needed." },
