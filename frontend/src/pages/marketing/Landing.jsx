...
export default function Landing() {
  usePageMeta({
    ...
    description: "The platform Australian cricket clubs run on: automated stats and a public club site (BetterStats core), plus BetterSelect, BetterSocials, BetterClubhouse and BetterIQ analytics, all fed by your club's own match data and synced automatically, with no manual data entry.",
